/*
    Read a sequence of double values into a vector. Think of each value as the distance between two cities along a given route. Compute and print the total distance (sum of
    all distances). Find and print the smallest and greatest distance between two neighbouring cities. Find and print the mean distance between two neighbouring cities.
*/
